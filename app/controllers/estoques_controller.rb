class EstoquesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @estoque.save
        format.html { redirect_to @estoque, notice: 'Criado com sucesso :).' }
  ...
  def update
    respond_to do |format|
      if @estoque.update(estoque_params)
        format.html { redirect_to @estoque, notice: 'Atualizado com sucesso :).' }
  ...
  def destroy
    @estoque.destroy
    respond_to do |format|
      format.html { redirect_to estoques_url, notice: 'Removido :).' }
  ...
  private
    ...
    def estoque_params
      params.require(:estoque).permit(:nome, :descricao, :valor, :quantidade, :grupo)
    end
end
