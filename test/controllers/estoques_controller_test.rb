...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estoque" do
    assert_difference('Estoque.count') do
      post estoques_url, params: { estoque: { descricao: @estoque.descricao, grupo: @estoque.grupo, nome: @estoque.nome, quantidade: @estoque.quantidade, valor: @estoque.valor } }
    end
  ...
  test "should update estoque" do
    patch estoque_url(@estoque), params: { estoque: { descricao: @estoque.descricao, grupo: @estoque.grupo, nome: @estoque.nome, quantidade: @estoque.quantidade, valor: @estoque.valor } }
